// @file : /third/bootstrap/js/jquery.validate.js
// @version : 2.0.2
...
var valid=true;var validator=$(this[0].form).validate();
this.each(function(){
...
var element=this[0];
if( command ){
var settings=$.data(element.form, "validator").settings;var staticRules=settings.rules;var existingRules=$.validator.staticRules(element);
switch(command){
case "add":
...
groups[name]=key;});});var rules=this.settings.rules;
...
this.currentElements=$(element);var result=this.check( element ) !==false;
if( result ){
...
element=this.validationTargetFor( this.clean( element ) );var rules=$(element).rules();var dependencyMismatch=false;var val=this.elementValue(element);var result;
...
var rules={};var classes=$(element).attr("class");
if( classes ){
...
var rules={};var $element=$(element);var type=$element[0].getAttribute("type");
...
var rules={};var validator=$.data(element.form, "validator");
...
previous.old=value;var validator=this;
...
validator.settings.messages[element.name].remote=previous.originalMessage;var valid=response===true || response==="true";
if( valid ){
...
var errors={};var message=response || validator.defaultMessage( element, "remote" );
...
return "pending";}}});
$.format=$.validator.format;}(jQuery));
(function($){
var pendingRequests={};
if( $.ajaxPrefilter ){
...
return handler.apply(target, arguments);}});}});}(jQuery));