// @file : /third/tablesorter/js/parsers/parser-named-numbers.js
// @version : 2.0.2
...
if( num !==null ){
group +=num;} else if( word===named.hundred ){
group *=100;} else if( power !==null ){
result +=group * power;
group=0;}};
